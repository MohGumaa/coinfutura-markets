...
const MOBILE_MENU_CLASSES = "flex-1 flex flex-col justify-between gap-x-2 gap-y-9 min-lg:flex-row min-lg:items-center min-lg:h-full max-lg:fixed max-lg:left-0 max-lg:z-40 max-lg:w-full max-lg:bg-white dark:max-lg:bg-gray-950 max-lg:border-t border-black/5 dark:border-white/10 max-lg:overflow-y-auto max-lg:px-3 max-lg:pt-4 max-sm:pb-16 max-lg:pb-4 max-lg:transition-all max-lg:duration-700 max-lg:ease-in-out"
